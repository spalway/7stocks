...
// nodes — the two lists show the same objects, so they sort and page the same.

import { useMemo, useState } from 'react';

const PER_PAGE = 10;

/// Sorts are over the serial parsed from each node's name.
///
...
/// Sorted, paged slice of a node list, plus the state its controls need.
