// Creates the Metaplex Core collection every CEO is minted into.
//
// The collection's update authority is the program's ["config"] PDA, which is
// what lets `mint_ceo` sign the Core CPI — and what stops anyone else minting
// into the collection. Run this once, before `npm run init`.

import { createSignerFromKeypair, publicKey, signerIdentity } from '@metaplex-foundation/umi';
import { createUmi } from '@metaplex-foundation/umi-bundle-defaults';
import { createCollection, ruleSet } from '@metaplex-foundation/mpl-core';
import { configPda } from '../src/chain.js';
